...
Label(root, text='Calculadora',bg ='#56CD63',fg='#F5EAEA', font=('Cambria',30),width='150',height='0').pack()
miFrame=Frame(root, width='600',height='400',bg='#4D4646')
miFrame.pack()
...
Label(miFrame, text=' = ',bg ='#4D4646',fg='#F5EAEA',justify='center').place(x='240',y='20')
Entry(miFrame, textvariable=Resultado  , width='13',justify='center').place(x='270',y='20')

Label(miFrame, text=' Numero 1 ',bg ='#4D4646',fg='#F5EAEA',justify='center').place(x='28',y='45')
Label(miFrame, text=' Numero 2 ',bg ='#4D4646',fg='#F5EAEA',justify='center').place(x='140',y='45')
Label(miFrame, text=' Resultado ',bg ='#4D4646',fg='#F5EAEA',justify='center').place(x='290',y='45')
def suma():
    a = int(numero_1.get())
    b = int(numero_2.get())
...
Button(miFrame, text='exit', width='45',height='0', command=root.destroy).place(x='5',y='200')
root.mainloop()